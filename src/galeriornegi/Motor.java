...
public class Motor {
	...
	//
	// Yazılımcı Class içinde hiçbir constructor tanımlamazsa Java o class için
	// otomatik boş
	// bir constructor oluşturur.
	// Ancak :
	// Yazılımcı içine pherhangi bir/birden fazla parametre alan bir constructor
	// tanımlarsa
	// Java otomatik constructor oluşturmaz. Bu durumda boş constructor'a ihtiyaç
	// duyarsanız sizin
	...
	public void motorBilgileriniYazdir() {
		System.out.println("Motor Hacmi: " + this.motorHacmi + " Şase numarası: " + this.saseNo + " Yakıt Tüketimi: "
				+ this.yakitTuketimi);

	}

	public String getAllMotorBilgileri() {
		String s = " motorHacmi: " + this.motorHacmi + " saseNo: " + this.saseNo + " yakıt tüketimi: "
				+ this.yakitTuketimi;
		return s;
	}

	public void setMotorHacmi(int motorHacmi) {
		if (motorHacmi >= 800 && motorHacmi <= 1000) {
			this.motorHacmi = motorHacmi;
		} else {
			System.out.println("motor hacmi 800-1000 dışında girdiğiniz için 800 olarak ayarlanmıştır!");
			this.motorHacmi = 800;
		}
	}
